...
namespace SimSmsOrg
{
    public class SimSmsOrgApi : ISmsService
    {
        ...
        public SimSmsOrgApi()
        {
            ...
            CountryParams[CountryCode.SA] = "53";
            CountryParams[CountryCode.MX] = "54";
            CountryParams[CountryCode.TW] = "55";
            CountryParams[CountryCode.ES] = "56";
            CountryParams[CountryCode.IR] = "57";
            CountryParams[CountryCode.DZ] = "58";
            CountryParams[CountryCode.SI] = "59";
            CountryParams[CountryCode.BD] = "60";
            CountryParams[CountryCode.SN] = "61";
            CountryParams[CountryCode.TR] = "62";
            CountryParams[CountryCode.CZ] = "63";
